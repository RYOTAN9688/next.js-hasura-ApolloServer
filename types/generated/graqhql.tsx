...
export type CreatedUserMutationVariables = Exact<{
  name: Scalars['String'];
}>;


export type CreatedUserMutation = { __typename?: 'mutation_root', insert_users_one?: { __typename?: 'users', id: any, name: string, created_at: any } | null | undefined };
...
export const CreatedUserDocument = gql`
    mutation CreatedUser($name: String!) {
  insert_users_one(object: {name: $name}) {
    ...
    `;
export type CreatedUserMutationFn = Apollo.MutationFunction<CreatedUserMutation, CreatedUserMutationVariables>;

/**
 * __useCreatedUserMutation__
 *
 * To run a mutation, you first call `useCreatedUserMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreatedUserMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createdUserMutation, { data, loading, error }] = useCreatedUserMutation({
 *   variables: {
 *      name: // value for 'name'
 *   },
 * });
 */
export function useCreatedUserMutation(baseOptions?: Apollo.MutationHookOptions<CreatedUserMutation, CreatedUserMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreatedUserMutation, CreatedUserMutationVariables>(CreatedUserDocument, options);
      }
export type CreatedUserMutationHookResult = ReturnType<typeof useCreatedUserMutation>;
export type CreatedUserMutationResult = Apollo.MutationResult<CreatedUserMutation>;
export type CreatedUserMutationOptions = Apollo.BaseMutationOptions<CreatedUserMutation, CreatedUserMutationVariables>;
